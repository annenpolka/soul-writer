          ...
          items: {
            ...
            properties: {
              ...
              variation_axis: {
                ...
                required: ['curve_type', 'intensity_target', 'differentiation_technique'],
              },
            },
            required: ['index', 'title', 'summary', 'key_events', 'target_length', 'dramaturgy', 'arc_role', 'decision_point'],
            additionalProperties: false,
          },
        },
      },
